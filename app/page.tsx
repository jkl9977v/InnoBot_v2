        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="max-w-2xl w-full">
            ...
            <p className="text-xl text-gray-600 mb-8 leading-relaxed">
              고객과의 소통을 자동화하고, 24시간 언제든지 빠르고 정확한 답변을 제공하는 
              지능형 챗봇 서비스입니다.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              최신 AI 기술을 바탕으로 한 스마트한 챗봇 솔루션의 핵심 기능들을 만나보세요
            </p>
          </div>
      ...
      <div className="py-24 bg-gradient-to-r from-indigo-600 to-purple-600">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-indigo-100 mb-8 max-w-2xl mx-auto">
            몇 분만에 나만의 AI 챗봇을 만들고, 고객과의 소통을 혁신적으로 개선해보세요
          </p>
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="col-span-1 md:col-span-2">
              ...
              <p className="text-gray-400 mb-4 max-w-md">
                AI 기술로 고객 서비스를 혁신하는 스마트 챗봇 플랫폼입니다. 
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center">
            <p className="text-gray-400">© 2024 TiumBot. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
